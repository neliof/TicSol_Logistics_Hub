...
const TABELAS: { chave: string; label: string; descricao: string }[] = [
  ...
  { chave: "auditoria", label: "Logs & Auditoria", descricao: "logistics.auditoria (registro de ações)" },
  { chave: "lotes", label: "Lotes de Produto", descricao: "logistics.lote (referencia produto)" },
  { chave: "regras", label: "Regras de Paletização", descricao: "logistics.regra_logistica (Motor de Regras por cliente)" },
  { chave: "encomendas", label: "Encomendas", descricao: "logistics.encomenda (referencia cliente)" },
